...
namespace GreatVEngine2
{
	...
	#if __GREAT_V_ENGINE_2__VULKAN__IMPLICIT_VALUE_OPERATIONS__
		public:
...
inline GreatVEngine2::Vulkan::DeviceSize::DeviceSize(const Value& value_):
	value(value_)
{
}

inline bool GreatVEngine2::Vulkan::DeviceSize::operator < (const DeviceSize& source_) const
{
...
inline GreatVEngine2::Vulkan::DeviceSize GreatVEngine2::Vulkan::DeviceSize::operator + (const DeviceSize& source_) const
{
	return DeviceSize(value + source_.value);
}

inline GreatVEngine2::Vulkan::DeviceSize::operator GreatVEngine2::Vulkan::DeviceSize::Value() const
{
	return value;
}
